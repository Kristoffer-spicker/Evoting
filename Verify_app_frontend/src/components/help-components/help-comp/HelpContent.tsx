...
import styles from '../help-styled-comp/helpContent.module.css';

const HelpContent = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <main ref={ref} className={styles.content}>
      <div className={styles.contentInner}>
        ...
        <section id="coercion" className={styles.section}>
          ...
          <div className={styles.sectionBody}>
            <p>
              Coercion in voting means when someone pressures or tries to make a voter vote the way they want and may later ask them to prove that they complied. The person applying this pressure is called a coercer.
        ...
        <section id="verify" className={styles.section}>
          ...
          <div className={styles.sectionBody}>
            ...
            <p>
              <ComputerIcon /> Open SURTR Verify on the same computer you used for registration.
            </p>
            <p>Login with your voter credentials.</p>
        ...
        <section id="never-voted" className={styles.section}>
          <h2 className={styles.sectionTitle}>What if I followed SURTR Verify but never voted?</h2>
          <div className={styles.sectionBody}>
            <p>
